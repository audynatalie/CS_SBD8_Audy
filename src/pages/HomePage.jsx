...
const HomePage = () => {
  ...
  return (
    <div className={`home-page ${theme}`}>
      ...
      <section className="case-studies-section" ref={caseStudiesRef}>
        <div className="container">
          <h2 className="section-title animate-on-scroll fade-in-up">Studi Kasus</h2>
          <div className="case-studies-grid">
            <div className="case-study-card animate-on-scroll slide-in-right">
              <div className="case-study-image">
                <img src={MandiriLogo} alt="Bank Mandiri" className="case-study-svg" />
              </div>
              <div className="case-study-content">
                <div className="case-study-badge">Perbankan</div>
                <h3>Bank Mandiri</h3>
                <p>Meningkatkan pengalaman nasabah dengan AI dan analitik data.</p>
                <Link to="/studi-kasus/bank-mandiri" className="case-study-link hover-effect">Baca selengkapnya →</Link>
              </div>
            </div>

            <div className="case-study-card animate-on-scroll slide-in-right" style={{animationDelay: '150ms'}}>
              <div className="case-study-image">
                <img src={PertaminaLogo} alt="Pertamina" className="case-study-svg" />
              </div>
              <div className="case-study-content">
                <div className="case-study-badge">Energi</div>
                <h3>Pertamina</h3>
                <p>Transformasi digital untuk efisiensi operasional yang lebih tinggi.</p>
                <Link to="/studi-kasus/pertamina" className="case-study-link hover-effect">Baca selengkapnya →</Link>
              </div>
            </div>
          </div>
        </div>
